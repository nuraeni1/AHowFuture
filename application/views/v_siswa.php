                                    ...
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        <div class="modal-body">
                                          <button class="btn-info"><a style="color:black" href="<?php echo base_url();?>index.php/download/saintek/download">SAINTEK</a></button>
                                          <button class="btn-warning"><a style="color:black" href="<?php echo base_url();?>index.php/download/soshum/download">SOSHUM</a></button>
                                          <button class="btn-info"><a style="color:black" href="<?php echo base_url();?>index.php/download/campuran/download">CAMPURAN</a></button>
                                        </div>
